...
DEPLOY_ENV=prod
DEPLOY_HOST=tremt-eriveltongoncalo.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
You need either a Ubuntu or Debian based system for tremt-eriveltongoncalo.tangrama.com.br, enable SSH, and install a supported version of Python 3 on that system.
...
prod:
  hosts:
    tremt-eriveltongoncalo.tangrama.com.br:
      ansible_user: root
      host: tremt-eriveltongoncalo
      hostname: tremt-eriveltongoncalo.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/tremt-eriveltongoncalo.tangrama.com.br.yml` to the remote server with:
